...
const ProductQuickView2 = ({ className = "" }) => {
        ...
        <div className="flex mt-3">
          {variants.map((variant, index) => (
            <div
              ...
              className={`relative flex-1 max-w-[75px] h-10 rounded-none border-2 cursor-pointer ${
                variantActive === index
      ...
      <div className="space-y-8">
        ...
        <div>
          <h2 className="text-2xl 2xl:text-3xl ">
            <Link href="/product-detail-2">Heavy Weight Shoes</Link>
          </h2>
