        ...
        <div className="columns-1 gap-4 sm:columns-2 xl:columns-3">
          {images.map(({ id, url }) => (
            <div
              ...
              className="after:content group relative mb-5 block w-full cursor-zoom-in after:pointer-events-none after:absolute after:inset-0 after: after:shadow-highlight focus:outline-none"
            >
              <Image
                alt="chisfis listing gallery "
                className="transform  brightness-90 transition will-change-auto group-hover:brightness-110 focus:outline-none"
                style={{
        ...
        <Dialog as="div" className="relative z-40" onClose={handleClose}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="sticky z-10 top-0 p-4 xl:px-10 flex items-center justify-between bg-white">
              <button
                className="focus:outline-none focus:ring-0 w-10 h-10 rounded-none flex items-center justify-center hover:bg-neutral-100"
                onClick={handleClose}
              >
