...
const SidebarFilters = () => {
  ...
  const renderTabsCategories = () => {
    return (
      <div className="relative flex flex-col pb-8 space-y-4">
        <h3 className=" mb-2.5">Categories</h3>
          ...
          <div>
            ...
            <div className="mt-1 relative rounded-none">
              ...
              <input
                ...
                disabled
                id="minPrice"
                className="block w-32 pr-10 pl-4 sm:text-sm border-neutral-200 dark:border-neutral-700 rounded-none bg-transparent"
                value={rangePrices[0]}
              />
            </div>
          </div>
  ...
  const renderTabsSortOrder = () => {
    return (
      <div className="relative flex flex-col py-8 space-y-4">
        <h3 className=" mb-2.5">Sort order</h3>
