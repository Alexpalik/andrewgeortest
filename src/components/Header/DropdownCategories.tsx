          ...
          <>
            <PopoverButton
              className={`${open ? "" : "text-opacity-90"}
                group py-2 h-10 sm:h-12 flex items-center rounded-none text-sm sm:text-base font-medium hover:text-opacity-100 focus:outline-none focus-visible:ring-0 `}
            >
              <span>Shops</span>
              <ChevronDownIcon
              ...
              <PopoverPanel className="absolute z-40 w-80 mt-3.5 transform -translate-x-1/2 left-1/2 sm:px-0">
                <div className="overflow-hidden rounded-2xl shadow-lg ring-1 ring-black ring-opacity-5">
                    ...
                    {CATEGORIES.map((item, index) => (
                      ...
                      >
                        <div
                          ...
                          className="flex items-center justify-center flex-shrink-0 w-10 h-10 bg-primary-50 rounded-none text-primary-500 sm:h-12 sm:w-12"
                        ></div>
                  ...
                  <div className="p-4 bg-neutral-50 dark:bg-neutral-700">
                    <Link
                      href="/collection-2"
                      className="flow-root px-2 py-2 space-y-0.5 transition duration-150 ease-in-out rounded-none focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
                    >
