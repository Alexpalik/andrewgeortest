...
const Heading: React.FC<HeadingProps> = ({
  ...
  isCenter = false,
  hasNextPrev = false,
  fontClass = "text-3xl md:text-4xl  font-serif",
  rightDescText,
      ...
      >
        ...
        >
          ...
          {rightDescText && (
            <>
              <span className="">{`. `}</span>
              <span className="text-neutral-500 dark:text-neutral-400 font-sans font-normal">
                {rightDescText}
              </span>
            </>
          )}
        ...
        {!!desc && (
          <span className="mt-2 md:mt-3 font-normal block text-base sm:text-xl text-neutral-500 dark:text-neutral-400 font-sans">
            {desc}
          </span>
        )}
      </div>
