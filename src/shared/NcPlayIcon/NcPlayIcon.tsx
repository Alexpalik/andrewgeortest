...
const NcPlayIcon: FC<NcPlayIconProps> = ({
  ...
  return (
    <div
      className={`nc-NcPlayIcon bg-white bg-opacity-30 backdrop-filter backdrop-blur rounded-none  ${className}`}
      data-nc-id="NcPlayIcon"
    >
      <div className="w-full h-full bg-white rounded-none text-primary-500 relative">
