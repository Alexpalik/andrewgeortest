                ...
                {() =>
                  renderItem && typeof renderItem(item) !== "undefined" ? (
                    ...
                    <Link
                      href={item.href}
                      className={
                        "flex items-center rounded-none w-full px-3 py-2 hover:bg-neutral-100 dark:hover:bg-neutral-800 hover:text-neutral-900 dark:hover:text-neutral-100 truncate "
                      }
                    >
                      {!!item.icon && (
