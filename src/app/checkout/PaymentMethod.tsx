...
interface Props {
  ...
  shippingAddress: BillingAddress; // For "same as shipping" option
}
...
const PaymentMethod: FC<Props> = ({
  ...
  const isPaymentMethodComplete = cardNumber.trim() !== "" && nameOnCard.trim() !== "" && expirationDate.trim() !== "" && cvc.trim() !== "";
    ...
    return (
      <div className="mt-6 space-y-4">
        ...
        <div className="flex items-center">
          ...
          />
          <label htmlFor="same-as-shipping" className="ml-2 text-sm text-gray-700 dark:text-gray-300">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleBillingAddressChange("streetAddress1", e.target.value)}
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleBillingAddressChange("streetAddress2", e.target.value)}
    ...
    return (
      <div className="flex items-start space-x-4 sm:space-x-6">
        ...
        <div className="flex-1">
          ...
          >
            <div
              className={`p-2.5 rounded-none border-2 ${
                active
  ...
  //             <li>
  //               <h3 className="text-base text-slate-800 dark:text-slate-200  mb-1">
  //                 ChisNghiax
  //               </h3>
  //             </li>
  //             <li>
      ...
      <div className="border border-slate-200 dark:border-slate-700 rounded-none ">
        <div className="p-6 flex flex-col sm:flex-row items-start">
          ...
          <div className="sm:ml-8">
            <h3 className="text-slate-700 dark:text-slate-400 flex items-center">
              <span className="uppercase tracking-tight">PAYMENT METHOD & BILLING</span>
            ...
            {isPaymentMethodComplete && (
              <div className="mt-1 text-sm text-slate-600 dark:text-slate-400">
                <span className="">**** **** **** {cardNumber.slice(-4)}</span>
                <span className="ml-3">{nameOnCard}</span>
              </div>
            )}
          </div>
          <button
