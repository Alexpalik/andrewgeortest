      ...
      <section className={styles.giftHeaderSection}>
        <div className={styles.giftHeaderContainer}>
          ...
          <p className={styles.giftSubtitle}>
            Μερικά δώρα δεν χωράνε σε κουτιά, αλλά μπορούν να προσφέρουν χαρά, άνεση ή ακόμα και στήριξη σε κάτι που έχει αξία για εσένα. Εδώ θα βρεις ιδέες για ψηφιακά δώρα προσαρμοσμένα στις ανάγκες και τις επιθυμίες σου...<br />
